...
const EditCategoryPage = ({ close, data: categoryData, fetchData }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 bg-opacity-70 flex items-center justify-center mt-24">
